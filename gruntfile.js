...
module.exports = function init(grunt) {
    ...
    grunt.initConfig({
        ...
        run: {
            ...
            copyArticlesToFirebase: { args: ['cp', 'public/articles/*', `${firebaseStorageUrl}articles`], cmd: 'gsutil -m' },
            copyBuildKitsToFirebase: { args: ['cp', 'public/buildKits/*', `${firebaseStorageUrl}buildKits`], cmd: 'gsutil' },
            copyEmulatorsToFirebase: { args: ['cp', 'public/emulators/**', `${firebaseStorageUrl}emulators`], cmd: 'gsutil -r' },
